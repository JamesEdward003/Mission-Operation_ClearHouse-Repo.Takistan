...
onMapSingleClick "";
		...
		switch (_sideUnit) do 
		{
			case west: 		{_infArray = [_spwnPos, WEST, (configFile >> "CfgGroups" >> "West" >> "BIS_US" >> "Armored" >> "US_M1A2Section")]};
			case east: 		{_infArray = [_spwnPos, EAST, (configFile >> "CfgGroups" >> "East" >> "BIS_TK" >> "Armored" >> "TK_T34Platoon")]};
			case resistance: 	{_infArray = [_spwnPos, RESISTANCE, (configFile >> "CfgGroups" >> "Guerrila" >> "BIS_TK_GUE" >> "Armored" >> "TK_GUE_T34Platoon")]};
			case civilian: 	{_infArray = [_spwnPos, CIVILIAN, (configFile >> "CfgGroups" >> "Guerrila" >> "BIS_TK_GUE" >> "Armored" >> "TK_GUE_T55Section")]};
		};
