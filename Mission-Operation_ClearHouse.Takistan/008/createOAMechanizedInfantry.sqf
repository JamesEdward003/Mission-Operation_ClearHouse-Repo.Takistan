...
/* Function file for Armed Assault
   ...
   [_spwnPos, WEST, (configFile >> "CfgGroups" >> "West" >> "BIS_US" >> "Mechanized" >> "US_MechanizedInfantrySquadICVMK19")] call BIS_fnc_spawnGroup;
*/
//////////////////////////////////////////////////////////////////
...
onMapSingleClick "";
		...
		switch (_sideUnit) do 
		{
			case west: 		{_infArray = [_spwnPos, WEST, (configFile >> "CfgGroups" >> "West" >> "BIS_US" >> "Mechanized" >> "US_MechanizedInfantrySquadICVMK19")]};
			case east: 		{_infArray = [_spwnPos, EAST, (configFile >> "CfgGroups" >> "East" >> "BIS_TK" >> "Mechanized" >> "TK_MechanizedReconSectionAT")]};
			case resistance: 	{_infArray = [_spwnPos, RESISTANCE, (configFile >> "CfgGroups" >> "Guerrila" >> "BIS_TK_GUE" >> "Mechanized" >> "TK_GUE_MechanizedGroup")]};
			case civilian: 	{_infArray = [_spwnPos, CIVILIAN, (configFile >> "CfgGroups" >> "Guerrila" >> "BIS_TK_GUE" >> "Mechanized" >> "TK_GUE_MechanizedPatrol")]};
		};
