...
/* Function file for Armed Assault
   ...
   [getMarkerPos "_infName", WEST, (configFile >> "CfgGroups" >> "West" >> "BIS_US" >> "Motorized" >> "US_MotorizedSectionAT")] call BIS_fnc_spawnGroup;
*/
//////////////////////////////////////////////////////////////////
...
onMapSingleClick "";
		...
		switch (_sideUnit) do 
		{
			case west: 		{_infArray = [_spwnPos, WEST, (configFile >> "CfgGroups" >> "West" >> "BIS_US" >> "Motorized" >> "US_MotorizedSectionAT")]};
			case east: 		{_infArray = [_spwnPos, EAST, (configFile >> "CfgGroups" >> "East" >> "BIS_TK" >> "Motorized" >> "TK_MotorizedReconSection")]};
			case resistance: 	{_infArray = [_spwnPos, RESISTANCE, (configFile >> "CfgGroups" >> "Guerrila" >> "BIS_TK_GUE" >> "Motorized" >> "TK_GUE_MotorizedGroup")]};
			case civilian: 	{_infArray = [_spwnPos, CIVILIAN, (configFile >> "CfgGroups" >> "Guerrila" >> "BIS_TK_GUE" >> "Motorized" >> "TK_GUE_Technicals")]};
		};
