///////// this addaction ["save loadout","cly_saveloadout.sqf"]; //////////
...
_unit addEventHandler ["Respawn",{_null = [_this select 0,_this select 1] call saveLoadout;}];
