/*       execVM "cly_addweapon_bizon.sqf"        */
...
_nul = [_unit,["bizon",7,"64Rnd_9x19_Bizon"],[_handGun,8],[_handGrenade,1],["pipebomb",1],[_smokeShell,1],"NVGoggles","Binocular_Vector"] execVM "Cly_AddWeapon\cly_addweapon.sqf";
