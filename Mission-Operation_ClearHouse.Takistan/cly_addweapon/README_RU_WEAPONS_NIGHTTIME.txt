//////////////////////////////////////////////////////////
	    case "USMC_Soldier_Officer"	: {
		    	_loadOut = "Cly_AddWeapon\cly_addweapon_unlimited_ammo_m249_tws_smaw.sqf";
        };		    
	    case "USMC_Soldier_SL"			: {
		    	_loadOut = "Cly_AddWeapon\cly_addweapon_unlimited_ammo_dmr_smaw.sqf";
        };
	    ...
	    case "USMC_Soldier_LAT"		: {
	    		_loadOut = "Cly_AddWeapon\cly_addweapon_unlimited_ammo_M249_TWS_M136.sqf";
        };
	    case "USMC_Soldier_AT"			: {
		    	_loadOut = "Cly_AddWeapon\cly_addweapon_unlimited_ammo_m249_tws_smaw.sqf";
        };
	    case "USMC_Soldier_HAT"		: {
		    	_loadOut = "Cly_AddWeapon\cly_addweapon_unlimited_ammo_M249_TWS_Javelin.sqf";
        };
	    case "USMC_Soldier_AA"			: {
		    	_loadOut = "Cly_AddWeapon\cly_addweapon_unlimited_ammo_m249_tws_stinger.sqf";
        };
	    case "USMC_SoldierS_Sniper"	: {
		    	_loadOut = "Cly_AddWeapon\cly_addweapon_unlimited_ammo_M107_TWS_smaw.sqf";
        }; 
	    ...
	    case "US_Soldier_Spotter_EP1"	: {
	    		_loadOut = "Cly_AddWeapon\cly_addweapon_unlimited_ammo_M110_TWS_smaw.sqf";
        };
	    case "US_Soldier_Sniper_NV_EP1"	: {
		    	_loadOut = "Cly_AddWeapon\cly_addweapon_unlimited_ammo_M110_NVG_smaw.sqf";
        };
