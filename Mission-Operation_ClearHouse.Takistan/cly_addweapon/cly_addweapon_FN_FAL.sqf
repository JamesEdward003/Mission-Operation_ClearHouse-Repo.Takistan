/*       execVM "cly_addweapon_FN_FAL.sqf"        */
...
_nul = [_unit,["FN_FAL",7,"20Rnd_762x51_FNFAL"],[_handGun,8],[_handGrenade,1],["pipebomb",1],[_smokeShell,1],"NVGoggles","Binocular_Vector"] execVM "Cly_AddWeapon\cly_addweapon.sqf";
