/*       execVM "cly_addweapon_SVD_CAMO.sqf"        */
...
_nul = [_unit,["SVD_CAMO",7,"10Rnd_762x54_SVD"],[_handGun,8],[_handGrenade,1],["pipebomb",1],[_smokeShell,1],"NVGoggles","Binocular_Vector"] execVM "Cly_AddWeapon\cly_addweapon.sqf";
