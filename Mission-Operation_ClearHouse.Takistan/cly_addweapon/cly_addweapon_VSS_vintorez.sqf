/*       execVM "cly_addweapon_VSS_vintorez.sqf"        */
...
_nul = [_unit,["VSS_vintorez",7,"10Rnd_9x39_SP5_VSS"],[_handGun,8],[_handGrenade,1],["pipebomb",1],[_smokeShell,1],"NVGoggles","Binocular_Vector"] execVM "Cly_AddWeapon\cly_addweapon.sqf";
