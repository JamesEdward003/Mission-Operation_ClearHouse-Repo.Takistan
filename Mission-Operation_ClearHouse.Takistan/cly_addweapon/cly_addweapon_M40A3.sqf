/*       execVM "cly_addweapon_M40A3.sqf"        */
...
_nul = [_unit,["M40A3",7,"5Rnd_762x51_M24"],[_handGun,8],[_handGrenade,1],["pipebomb",1],[_smokeShell,1],"NVGoggles","Binocular_Vector"] execVM "Cly_AddWeapon\cly_addweapon.sqf";
