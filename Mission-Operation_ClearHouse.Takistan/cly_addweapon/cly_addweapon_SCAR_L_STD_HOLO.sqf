/*       execVM "cly_addweapon_SCAR_L_STD_HOLO.sqf"        */
...
_nul = [_unit,["SCAR_L_STD_HOLO",7,"30Rnd_556x45_Stanag"],[_handGun,8],[_handGrenade,1],["pipebomb",1],[_smokeShell,1],"NVGoggles","Binocular_Vector"] execVM "Cly_AddWeapon\cly_addweapon.sqf";
