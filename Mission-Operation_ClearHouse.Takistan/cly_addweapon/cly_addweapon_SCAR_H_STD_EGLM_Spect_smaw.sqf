/////////////////////////////////execVM "cly_addweapon_SCAR_H_STD_EGLM_Spect_smaw.sqf"////////////////////////////////
...
_nul = [_unit,["SCAR_H_STD_EGLM_Spect",6,0,4,0],["SMAW",1,"SMAW_HEDP"],[_handGun,4],[_handGrenade,1],[_smokeShell,1],"NVGoggles","Binocular_Vector"] execVM "Cly_AddWeapon\cly_addweapon.sqf";
