/*       execVM "cly_addweapon_Mk_48.sqf"        */
...
_nul = [_unit,["Mk_48",7,"100Rnd_762x51_M240"],[_handGun,8],[_handGrenade,1],["pipebomb",1],[_smokeShell,1],"NVGoggles","Binocular_Vector"] execVM "Cly_AddWeapon\cly_addweapon.sqf";
