/*       execVM "cly_addweapon_Saiga12K.sqf"        */
...
_nul = [_unit,["Saiga12K",7,"8Rnd_B_Saiga12_74Slug"],[_handGun,8],[_handGrenade,1],["pipebomb",1],[_smokeShell,1],"NVGoggles","Binocular_Vector"] execVM "Cly_AddWeapon\cly_addweapon.sqf";
