/*       execVM "cly_addweapon_M14_EP1.sqf"        */
...
_nul = [_unit,["M14_EP1",7,"20Rnd_762x51_DMR"],[_handGun,8],[_handGrenade,1],["pipebomb",1],[_smokeShell,1],"NVGoggles","Binocular_Vector"] execVM "Cly_AddWeapon\cly_addweapon.sqf";
