/*       execVM "cly_addweapon_M16A2.sqf"        */
...
_nul = [_unit,["M16A2",7,"30Rnd_556x45_Stanag"],[_handGun,8],[_handGrenade,1],["pipebomb",1],[_smokeShell,1],"NVGoggles","Binocular_Vector"] execVM "Cly_AddWeapon\cly_addweapon.sqf";
