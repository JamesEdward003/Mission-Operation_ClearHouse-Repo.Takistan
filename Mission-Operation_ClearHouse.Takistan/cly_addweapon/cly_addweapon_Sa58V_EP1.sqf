/*       execVM "cly_addweapon_Sa58V_EP1.sqf"        */
...
_nul = [_unit,["Sa58V_EP1",7,"30Rnd_762x39_SA58"],[_handGun,8],[_handGrenade,1],["pipebomb",1],[_smokeShell,1],"NVGoggles","Binocular_Vector"] execVM "Cly_AddWeapon\cly_addweapon.sqf";
