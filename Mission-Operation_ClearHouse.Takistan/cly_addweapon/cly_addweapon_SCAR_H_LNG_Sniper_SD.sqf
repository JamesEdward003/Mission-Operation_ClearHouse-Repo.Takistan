/*       execVM "cly_addweapon_SCAR_H_LNG_Sniper_SD.sqf"        */
...
_nul = [_unit,["SCAR_H_LNG_Sniper_SD",7,"20Rnd_762x51_SB_SCAR"],[_handGun,8],[_handGrenade,1],["pipebomb",1],[_smokeShell,1],"NVGoggles","Binocular_Vector"] execVM "Cly_AddWeapon\cly_addweapon.sqf";
