...
_nul = [_unit,["bizon",4,"64Rnd_9x19_Bizon"],["MetisLauncher",1],[_handGun,8],[_handGrenade,1],[_smokeShell,1],"NVGoggles","Binocular_Vector"] execVM "Cly_AddWeapon\cly_addweapon.sqf";
