/*       execVM "cly_addweapon_m8_SAW.sqf"        */
...
_nul = [_unit,["m8_SAW",7,"100Rnd_556x45_BetaCMag"],[_handGun,8],[_handGrenade,1],["pipebomb",1],[_smokeShell,1],"NVGoggles","Binocular_Vector"] execVM "Cly_AddWeapon\cly_addweapon.sqf";
