/*       execVM "cly_addweapon_m8_sharpshooter.sqf"        */
...
_nul = [_unit,["m8_sharpshooter",7,"30Rnd_556x45_G36"],[_handGun,8],[_handGrenade,1],["pipebomb",1],[_smokeShell,1],"NVGoggles","Binocular_Vector"] execVM "Cly_AddWeapon\cly_addweapon.sqf";
