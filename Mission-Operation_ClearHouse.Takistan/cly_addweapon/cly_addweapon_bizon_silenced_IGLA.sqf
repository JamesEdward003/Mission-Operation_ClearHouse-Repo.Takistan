/*       execVM "cly_addweapon_bizon_silenced_IGLA.sqf"        */
...
_nul = [_unit,["bizon_silenced",7,"64Rnd_9x19_SD_Bizon"],["IGLA",1],[_handGun,8],[_handGrenade,1],["pipebomb",1],[_smokeShell,1],"NVGoggles","Binocular_Vector"] execVM "Cly_AddWeapon\cly_addweapon.sqf";
