...
_nul = [_unit,["DMR",10,"20Rnd_762x51_DMR"],[_handGun,8],[_handGrenade,1],[_smokeShell,1],"NVGoggles","Binocular_Vector"] execVM "Cly_AddWeapon\cly_addweapon.sqf";
