/*       execVM "cly_addweapon_M60A4_EP1.sqf"        */
...
_nul = [_unit,["M60A4_EP1",7,"100Rnd_762x51_M240"],[_handGun,8],[_handGrenade,1],["pipebomb",1],[_smokeShell,1],"NVGoggles","Binocular_Vector"] execVM "Cly_AddWeapon\cly_addweapon.sqf";
