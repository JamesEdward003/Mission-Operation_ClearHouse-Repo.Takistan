/////////////////////////////////execVM "cly_addweapon_SVD_NSPU_EP1_RPG7V.sqf"////////////////////////////////
...
_nul = [_unit,["SVD_NSPU_EP1",7,"10Rnd_762x54_SVD"],["RPG7V",1,2],[_handGun,8],[_handGrenade,1],[_smokeShell,1],"NVGoggles","Binocular_Vector"] execVM "Cly_AddWeapon\cly_addweapon.sqf";
